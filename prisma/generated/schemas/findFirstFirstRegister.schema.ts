...
export const FirstRegisterFindFirstSelectSchema: z.ZodType<Prisma.FirstRegisterSelect> = z.object({
...
export const FirstRegisterFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    email: z.boolean().optional(),
    username: z.boolean().optional(),
    code: z.boolean().optional(),
...
export const FirstRegisterFindFirstSchema: z.ZodType<Prisma.FirstRegisterFindFirstArgs> = z.object({ select: FirstRegisterFindFirstSelectSchema.optional(),  orderBy: z.union([FirstRegisterOrderByWithRelationInputObjectSchema, FirstRegisterOrderByWithRelationInputObjectSchema.array()]).optional(), where: FirstRegisterWhereInputObjectSchema.optional(), cursor: FirstRegisterWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([FirstRegisterScalarFieldEnumSchema, FirstRegisterScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.FirstRegisterFindFirstArgs>;

export const FirstRegisterFindFirstZodSchema = z.object({ select: FirstRegisterFindFirstSelectSchema.optional(),  orderBy: z.union([FirstRegisterOrderByWithRelationInputObjectSchema, FirstRegisterOrderByWithRelationInputObjectSchema.array()]).optional(), where: FirstRegisterWhereInputObjectSchema.optional(), cursor: FirstRegisterWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([FirstRegisterScalarFieldEnumSchema, FirstRegisterScalarFieldEnumSchema.array()]).optional() }).strict();