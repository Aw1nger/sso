...
export const KeyPairFindFirstOrThrowSelectSchema: z.ZodType<Prisma.KeyPairSelect> = z.object({
...
export const KeyPairFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    publicKey: z.boolean().optional(),
    privateKey: z.boolean().optional(),
    createdAt: z.boolean().optional(),
...
export const KeyPairFindFirstOrThrowSchema: z.ZodType<Prisma.KeyPairFindFirstOrThrowArgs> = z.object({ select: KeyPairFindFirstOrThrowSelectSchema.optional(),  orderBy: z.union([KeyPairOrderByWithRelationInputObjectSchema, KeyPairOrderByWithRelationInputObjectSchema.array()]).optional(), where: KeyPairWhereInputObjectSchema.optional(), cursor: KeyPairWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([KeyPairScalarFieldEnumSchema, KeyPairScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.KeyPairFindFirstOrThrowArgs>;

export const KeyPairFindFirstOrThrowZodSchema = z.object({ select: KeyPairFindFirstOrThrowSelectSchema.optional(),  orderBy: z.union([KeyPairOrderByWithRelationInputObjectSchema, KeyPairOrderByWithRelationInputObjectSchema.array()]).optional(), where: KeyPairWhereInputObjectSchema.optional(), cursor: KeyPairWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([KeyPairScalarFieldEnumSchema, KeyPairScalarFieldEnumSchema.array()]).optional() }).strict();