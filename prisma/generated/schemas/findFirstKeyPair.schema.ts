...
export const KeyPairFindFirstSelectSchema: z.ZodType<Prisma.KeyPairSelect> = z.object({
...
export const KeyPairFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    publicKey: z.boolean().optional(),
    privateKey: z.boolean().optional(),
    createdAt: z.boolean().optional(),
...
export const KeyPairFindFirstSchema: z.ZodType<Prisma.KeyPairFindFirstArgs> = z.object({ select: KeyPairFindFirstSelectSchema.optional(),  orderBy: z.union([KeyPairOrderByWithRelationInputObjectSchema, KeyPairOrderByWithRelationInputObjectSchema.array()]).optional(), where: KeyPairWhereInputObjectSchema.optional(), cursor: KeyPairWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([KeyPairScalarFieldEnumSchema, KeyPairScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.KeyPairFindFirstArgs>;

export const KeyPairFindFirstZodSchema = z.object({ select: KeyPairFindFirstSelectSchema.optional(),  orderBy: z.union([KeyPairOrderByWithRelationInputObjectSchema, KeyPairOrderByWithRelationInputObjectSchema.array()]).optional(), where: KeyPairWhereInputObjectSchema.optional(), cursor: KeyPairWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([KeyPairScalarFieldEnumSchema, KeyPairScalarFieldEnumSchema.array()]).optional() }).strict();