...
// @ts-nocheck 
/*
 * This file exports the `FirstRegister` model and its related types.
 *
...
export type GetFirstRegisterAggregateType<T extends FirstRegisterAggregateArgs> = {
      [P in keyof T & keyof AggregateFirstRegister]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateFirstRegister[P]>
    : Prisma.GetScalarType<T[P], AggregateFirstRegister[P]>
}
...
export type GetFirstRegisterGroupByPayload<T extends FirstRegisterGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<FirstRegisterGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof FirstRegisterGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], FirstRegisterGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], FirstRegisterGroupByOutputType[P]>
      }
    >
  >
...
export type FirstRegisterCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<FirstRegisterFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface FirstRegisterDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['FirstRegister'], meta: { name: 'FirstRegister' } }
  /**
   ...
   * })
  **/
  count<T extends FirstRegisterCountArgs>(
    args?: Prisma.Subset<T, FirstRegisterCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], FirstRegisterCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends FirstRegisterGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, FirstRegisterGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetFirstRegisterGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
